...
var globalTweetMap = new Map();
var globalTweetFilterMap = new Map();
var debug = true;
function recognizeImageText(_x) {
  return _recognizeImageText.apply(this, arguments);
}
function _recognizeImageText() {
  _recognizeImageText = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(imageUrl) {
    var _yield$Tesseract$reco, text;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return tesseract_js__WEBPACK_IMPORTED_MODULE_0___default().recognize(imageUrl, 'eng');
        case 3:
          _yield$Tesseract$reco = _context.sent;
          text = _yield$Tesseract$reco.data.text;
        ...
        case 8:
          ...
          console.error('OCR failed', _context.t0);
        case 11:
        case "end":
...
function extractTweetId(tweet) {
  ...
  if (linkElement) {
    ...
    var statusPosition = href.indexOf('/status/') + 8; // +8 to move past '/status/'
...
function getContent(textsDom) {
  var content = "";
  var _iterator = _createForOfIteratorHelper(textsDom),
    _step;
  try {
    for (_iterator.s(); !(_step = _iterator.n()).done;) {
      var textDom = _step.value;
...
function toggleVisibility(tweet, event) {
  ...
  var tweetId = extractTweetId(tweet);
  if (globalTweetFilterMap.has(tweetId)) {
    var currentValue = globalTweetFilterMap.get(tweetId);
...
function insertLearnButton(tweet) {
  ...
  var bookmarkButtons = tweet.querySelectorAll('[data-testid="bookmark"], [data-testid="removeBookmark"]');
  var clonedButtons = tweet.querySelectorAll('[data-testid="learnbutton"]');
  if (clonedButtons.length === 0 && bookmarkButtons.length > 0) {
    var bookmarkButton = bookmarkButtons[0];
    var cloneBookmarkButton = bookmarkButton.cloneNode(true);
    ...
    var svgElement = cloneBookmarkButton.querySelector('svg');
    if (svgElement) {
      var newPath = "M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm5 13h-3v3h-4v-3H7v-4h3V8h4v3h3v4z";
...
function greyOutTweet(textsDom) {
  textsDom.forEach(function (textDom) {
    if (textDom.tagName.toLowerCase() === "span") {
...
function filterTweets() {
  return _filterTweets.apply(this, arguments);
}
function _filterTweets() {
  _filterTweets = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    var tweetsData, requestBody, response, data, filteredTweetResults;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          tweetsData = Array.from(globalTweetMap).filter(function (_ref) {
            var _ref2 = _slicedToArray(_ref, 1),
              tweetId = _ref2[0];
            return !globalTweetFilterMap.has(tweetId);
          }).map(function (_ref3) {
          ...
          _context2.next = 5;
          return fetch('http://localhost:8080/filter:filter:template.os/filter', {
            method: 'POST',
            headers: {
        ...
        case 8:
          data = _context2.sent;
          filteredTweetResults = data || [];
          filteredTweetResults.forEach(function (_ref5) {
            var tweetId = _ref5.tweetId,
              filterBool = _ref5.filterBool;
        ...
        case 13:
          ...
          console.error("Failed to filter tweets:", _context2.t0);
        case 16:
        case "end":
...
function updateVisuals() {
  return _updateVisuals.apply(this, arguments);
}
function _updateVisuals() {
  _updateVisuals = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
    var tweets, _iterator3, _step3, _loop;
    return _regeneratorRuntime().wrap(function _callee3$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          tweets = document.querySelectorAll("[data-testid=cellInnerDiv] > *");
          _iterator3 = _createForOfIteratorHelper(tweets);
          _context4.prev = 2;
          _loop = /*#__PURE__*/_regeneratorRuntime().mark(function _loop() {
            var tweet, textsDom, tweetId, should_pass;
            return _regeneratorRuntime().wrap(function _loop$(_context3) {
              while (1) switch (_context3.prev = _context3.next) {
                case 0:
                  tweet = _step3.value;
                  textsDom = tweet.querySelectorAll("[data-testid=tweetText] > *");
                  tweetId = extractTweetId(tweet);
                  insertLearnButton(tweet);
                  if (!globalTweetMap.has(tweetId)) {
                    greyOutTweet(textsDom);
                  } else {
                    should_pass = globalTweetFilterMap.get(tweetId);
                    if (should_pass) {
                      if (tweet.firstChild) {
...
function populateGlobalTweetMap() {
  ...
  try {
    for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
      ...
      var textsDom = tweet.querySelectorAll("[data-testid=tweetText] > *");
      var tweetId = extractTweetId(tweet);
      var content = getContent(textsDom);
      if (tweetId && content) {
...
function parseState() {
  return _parseState.apply(this, arguments);
}
function _parseState() {
  _parseState = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4() {
